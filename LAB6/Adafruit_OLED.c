...
*/
    ...
    GPIOPinWrite(GPIOA1_BASE, 0x80, 0); //set CS pin to LOW
    GPIOPinWrite(GPIOA1_BASE, 0x40, 0); //set DC pin to LOW for command

    SPIDataPut(GSPI_BASE, c);   //send over SPI
    SPIDataGet(GSPI_BASE,&ulDummy);

    GPIOPinWrite(GPIOA1_BASE, 0x80, 0x80); //set CS pin to HIGH
...
*/
    ...
    GPIOPinWrite(GPIOA1_BASE, 0x80, 0); //set CS pin to LOW
    GPIOPinWrite(GPIOA1_BASE, 0x40, 0x40); //set DC pin to LOW for command
