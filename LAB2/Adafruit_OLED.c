...
*/
    ...
    GPIOPinWrite(GPIOA1_BASE, 0x80, 0); //cs low
    GPIOPinWrite(GPIOA1_BASE, 0x40, 0); //dc low
    MAP_SPIDataPut(GSPI_BASE,c);
    SPIDataGet(GSPI_BASE, &ulDummy);
    GPIOPinWrite(GPIOA1_BASE, 0x80, 0x80); //cs high
...
*/
    ...
    SPICSEnable(GSPI_BASE);
    GPIOPinWrite(GPIOA1_BASE, 0x80, 0); //cs low
    GPIOPinWrite(GPIOA1_BASE, 0x40, 0x40); //dc low
    MAP_SPIDataPut(GSPI_BASE,c);
    SPIDataGet(GSPI_BASE, &nothing);
    GPIOPinWrite(GPIOA1_BASE, 0x80, 0x80); //cs high
    SPICSDisable(GSPI_BASE);
